...
abstract class ConfigurationClassUtils {
	...
	/**
	 * Check whether the given bean definition is a candidate for a configuration
	 * class (or a nested component class declared within a configuration/component
	...
	public static boolean checkConfigurationClassCandidate(BeanDefinition beanDef, MetadataReaderFactory metadataReaderFactory) {
		...
		// It's a full or lite configuration candidate... Let's determine the order
		// value, if any.
	 ...
	 * 
	 * @param metadata the metadata of the annotated class
	 * @return the {@link @Order} annotation value on the configuration class, or
	...
	/**
	 * Determine the order for the given configuration class bean definition, as set
	 * by {@link #checkConfigurationClassCandidate}.
	 * 
	 * @param beanDef the bean definition to check
	 * @return the {@link @Order} annotation value on the configuration class, or
	 *         {@link Ordered#LOWEST_PRECEDENCE} if none declared
